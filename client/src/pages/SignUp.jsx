      ...
      md-items-center gap-6'>
        ...
        <div className='flex-1 mt-20'>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            <div>
              <Label className='text-lg' htmlFor='username' color='black'>Your username</Label>
              <TextInput  type='text' placeholder='Username' id='username' onChange={handleChange}/>
            </div>

            <div>
              <Label className="text-lg"htmlFor='email' color='black'>Your email</Label>
              <TextInput type='email' placeholder='Email' id='email' onChange={handleChange}/>
            </div>

            <div>
              <Label className='text-lg' htmlFor='password' color='black'>Your password</Label>
              <TextInput type='password' placeholder='Password' id='password' onChange={handleChange}/>
            </div>
            {/* <Button gradientDuoTone="purpleToPink" type='submit'>Sign Up</Button> */}
            <Button className='bg-gradient-to-r from-purple-500 to-pink-500 text-white' type='submit' disabled={loading}>
              {loading ? (
                <>
                <Spinner size='sm'/>
